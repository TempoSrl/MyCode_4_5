...
[Obsolete("Use form.getInstance<IDataAccess>()")] public DataAccess Conn;
     ...
     /// <summary>
        ...
        /// <param name="T"></param>
        /// <param name="listingType"></param>
        public virtual void DescribeColumns(DataTable T, string listingType) {
        ...
        /// <param name="listtype"></param>
        [Obsolete]
        public static void DescribeListType(DataAccess Conn, DataTable T, string listtype) {

            //metaprofiler.StopTimer(handle);
            describeListType(Conn, T, listtype);
        }
        ...
        /// </summary>
        public bool getDataIsPrivate {
            get { return privateGetData; }
            set { privateGetData = value; }
        }
