...
namespace mdl {
    ...
    public class QueryCreator {
		...
		/// <param name="T"></param>
		/// <param name="S"></param>
		public static void SetSearchFilter(DataTable T, q S) {
        ...
        public static bool IsSkipInsertCopy(DataTable t) {
            if (t.ExtendedProperties["skipInsertCopy"] == null)
                return false;
        ...
        /// <returns></returns>
		public static q GetRelationActivationFilter(DataRelation Rel) {
            if (Rel.ExtendedProperties["activationfilter"] == null)
                return null;
            return Rel.ExtendedProperties["activationfilter"] as q;
        }
		...
		public static void SetRelationActivationFilter(DataRelation Rel, q filter) {
        ...
        /// <param name="T"></param>
        /// <param name="filter"></param>
        public static void SetFilterForInsert(DataTable T, q filter) {
        ...
        /// <param name="T"></param>
        /// <returns></returns>
		public static q GetFilterForInsert(DataTable T) {
            if (T == null)
                return null;
            return T.ExtendedProperties["FilterForInsert"] as q;
        }
        ...
        /// <param name="T"></param>
        /// <param name="filter"></param>
        public static void SetFilterForSearch(DataTable T, MetaExpression filter) {
        ...
        /// <param name="T"></param>
        /// <returns></returns>
        public static MetaExpression GetFilterForSearch(DataTable T) {
            if (T == null)
                return null;
            return T.ExtendedProperties["FilterForSearch"] as MetaExpression;
        }
        ...
        static public MultiCompare ParentChildFilter(DataRow ParentRow,
            ...
            for (var i = 0; i < ParentCol.Length; i++) {
                ...
                if (SQL)
                    fieldname = Child.PostingColumnName();
        ...
        public static bool CheckKeyParent(DataTable Parent, DataTable Child) {
            ...
            foreach (var C in Rfound.ChildColumns) {
                if (IsPrimaryKey(Child, C.ColumnName))
                    return true;
            }
            return false;
        }
        ...
        public static DataRelation GetParentChildRel(DataTable Parent, DataTable Child) {
            ...
            if (Child == null)
                return null;
            foreach (DataRelation R in Parent.ChildRelations) {
                if (R.ChildTable.TableName == Child.TableName)
                    return R;
            }
            return null;
        }
