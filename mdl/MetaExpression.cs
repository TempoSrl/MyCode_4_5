...
namespace mdl {
    ...
    public abstract class MetaExpression {
        ...
        public virtual MetaExpression Compile<T>() {
            ...
            string outBody =
                $"namespace metadatalibrary {{ public class {newClassName} {{ " +
        ...
        public static MetaExpression fromObject(object par, bool autofield = false) {
            ...
            if (autofield && par is string) {
                return new MetaExpressionField((string)par);
            }
        ...
        public static void setField(object o, string fieldName, object value) {
            try {
                ...
                if (o is DataRow) {
                    ...
                    ((DataRow)o)[fieldName]=value;
                    return;
                }
                if (o is RowObject) {
                    ((RowObject)o)[fieldName]=value;
                    return;
                }
        ...
        public static object getField(string fieldName, object o) {
            try {
                ...
                if (o is DataRow) {
                    ...
                    //    ? DataRowVersion.Original
                    //    : DataRowVersion.Default;
                    return ((DataRow)o)[fieldName];
                }
                if (o is RowObject) {
                    return ((RowObject)o)[fieldName];
                }
                if(o is ExpandoObject e) {
                    IDictionary<string, object> dict = e;
                    if(dict.TryGetValue(fieldName, out var res)) {
                        if(res == null)
                            res = DBNull.Value;
                    }
                    else {
        ...
        /// <param name="fieldName"></param>
        /// <returns></returns>
        public static MetaExpression eeq(string fieldName) {
            return tryEval(new MetaExpressionEq(fieldName, MetaExpression.field(fieldName)));
        }
    ...
    class MetaExpressionConst : MetaExpression {
        ...
        public MetaExpressionConst(object o) {
            value = o;
            if (o is ICloneable) value = ((ICloneable)o).Clone();
        ...
        public override string getCCode(Compiler c, string varName, Type T) {
            ...
            if (value is decimal) return ((decimal)(value)).ToString(nfi)+"M";
            if (value is double) return ((double)(value)).ToString(nfi)+"D";
            if (value is float) return ((float)(value)).ToString(nfi)+"F";
            if (value is long) return ((long)(value)).ToString() + "L";
            if (value is ulong) return ((long)(value)).ToString() + "UL";
            if (value is uint) return ((long)(value)).ToString() + "U";
    ...
    class MetaExpressionEq : MetaExpression, IGetCompDictionary{
        ...
        /// <returns></returns>
        public Dictionary<string, object> getMcmpDictionary() {
	        var eqFun = Parameters[0] as MetaExpressionField;
	        if (eqFun == null) return null;
	        var valueFun = Parameters[1] as MetaExpressionConst;
	        if (valueFun == null) return null;
    ...
    class MetaExpressionGe : MetaExpression {
        ...
        public override string getCCode(Compiler c, string varName, Type T) {
            ...
            var namevar1 = c.getNewVarName();
            var namevar2 = c.getNewVarName();
            if (detected != null) {
    ...
    #region NullOrSomething
    /*
    class MetaExpressionNullOrEq : MetaExpression {


        public MetaExpressionNullOrEq(params object[] par) {
            Parameters = getParams(par, true);
            Name = "nullOrEq";
        }
        ...
        public override object apply(object o = null, dynamic env = null) {
            ...
            if (par1 == DBNull.Value) return true;
        ...
        public override string toSql(QueryHelper q, dynamic env = null) {
            var par1 = Parameters[0];
            var par2 = Parameters[1];
            return q.NullOrEq(par1.toSql(q, env), par2.toSql(q, env));
        }

        public override string toString() {
            return $"nullOrEq({Parameters[0].toString()},{Parameters[1].toString()})";
        }
    }

    class MetaExpressionNullOrNe : MetaExpression {


        public MetaExpressionNullOrNe(params object[] par) {
            Parameters = getParams(par, true);
            Name = "nullOrNe";
        }
        ...
        public override string toSql(QueryHelper q, dynamic env = null) {
            var par1 = Parameters[0];
            var par2 = Parameters[1];
            return q.NullOrNe(par1.toSql(q, env), par2.toSql(q, env));
        }

        public override string toString() {
            return $"nullOrNe({Parameters[0].toString()},{Parameters[1].toString()})";
        }
    }

    class MetaExpressionNullOrLt : MetaExpression {


        public MetaExpressionNullOrLt(params object[] par) {
            Parameters = getParams(par, true);
            Name = "nullOrLt";
        }
        ...
        public override object apply(object o = null, dynamic env = null) {
            ...
            dynamic par2 = Parameters[1].apply(o, env);
            if (par1 == null || par2 == null) return null;
            if (DBNull.Value.Equals(par1)) return true;
            if (DBNull.Value.Equals(par2)) return false;
            if (par1 is string) return String.Compare(par1, par2) < 0;
            return par1 < par2;
        }
        ...
        public override string toSql(QueryHelper q, dynamic env = null) {
            var par1 = Parameters[0];
            var par2 = Parameters[1];
            if (par1.isNull()) return q.IsNull(par1.toSql(q, env));
            return q.NullOrLt(par1.toSql(q, env), par2.toSql(q, env));
        }

        public override string toString() {
            return $"nullOrLt({Parameters[0].toString()},{Parameters[1].toString()})";
        }
    }

    class MetaExpressionNullOrGt : MetaExpression {


        public MetaExpressionNullOrGt(params object[] par) {
            Parameters = getParams(par, true);
            Name = "nullOrGt";
        }
        ...
        public override string toSql(QueryHelper q, dynamic env = null) {
            ...
            var par2 = Parameters[1];
            if (par1.isNull()) return q.IsNull(par1.toSql(q, env));
            return q.NullOrGt(par1.toSql(q, env), par2.toSql(q, env));
        }

        public override string toString() {
            return $"nullOrGt({Parameters[0].toString()},{Parameters[1].toString()})";
        }
    }

    class MetaExpressionNullOrGe : MetaExpression {


        public MetaExpressionNullOrGe(params object[] par) {
            Parameters = getParams(par, true);
            Name = "nullOrGe";
        }
        ...
        public override string toSql(QueryHelper q, dynamic env = null) {
            ...
            var par2 = Parameters[1];
            if (par1.isNull()) return q.IsNull(par1.toSql(q, env));
            return q.NullOrGe(par1.toSql(q, env), par2.toSql(q, env));
        }

        public override string toString() {
            return $"nullOrGe({Parameters[0].toString()},{Parameters[1].toString()})";
        }
    }

    class MetaExpressionNullOrLe : MetaExpression {


        public MetaExpressionNullOrLe(params object[] par) {
            Parameters = getParams(par, true);
            Name = "nullOrLe";
        }
        ...
        public override string toSql(QueryHelper q, dynamic env = null) {
            ...
            var par2 = Parameters[1];
            if (par1.isNull()) return q.IsNull(par1.toSql(q, env));
            return q.NullOrLe(par1.toSql(q, env), par2.toSql(q, env));
        }

        public override string toString() {
            return $"nullOrLe({Parameters[0].toString()},{Parameters[1].toString()})";
        }
    }
    */
    #endregion
    ...
    //class MetaExpressionCmpMask : MetaExpression {
    //    private readonly ulong _mask;
    //    private readonly ulong _val;

    //    public MetaExpressionCmpMask(object field, ulong mask, ulong val) {
    ...
    //        if (par == DBNull.Value) return DBNull.Value;
    //        if (_mask == 0) return (par.Equals(_val));
    //        return (par & _mask) == _val;
    //    }

    //    public override string toString() {
    //        return $"cmpMask({Parameters[0].toString()},{_mask},{_val})";
    //    }

    //    public override string toSql(QueryHelper q, dynamic env = null) {
    //        if (_mask == 0) {
    //            return q.CmpEq(Parameters[0].toSql(q, env), _val);
    //        }
    //        List<MetaExpression> allPieces = new List<MetaExpression>();
    //        int i = 0;
    //        ulong mask = _mask;
    //        ulong val = _val;
    //        object par = Parameters[0];
    //        while (mask != 0) {
    //            if ((mask & 1) != 0) {
    //                if ((val & 1) != 0) {
    //                    allPieces.Add(new MetaExpressionBitSet(par, i));
    //                }
    //                else {
    //                    allPieces.Add(new MetaExpressionBitClear(par, i));
    //                }
    //            }
    //            mask = mask >> 1;
    //            val = val >> 1;
    ...
    //        }
    //        MetaExpression mAnd = new MetaExpressionAnd((from r in allPieces select r as object).ToArray());
    //        return mAnd.toSql(q, env);
    //    }
    //}
